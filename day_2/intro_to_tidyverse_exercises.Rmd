...
- the file  "../src/tx_expression_subset.tsv.gz" has some data from a real RNA-seq experiment and contains transcript expression values; there are two columns for the gene and transcript name, and the rest of the columns are the samples each transcript is expressed in. 
