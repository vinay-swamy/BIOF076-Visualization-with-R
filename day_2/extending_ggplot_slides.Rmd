...
## animated plots 
- animated pltos are all the rage these days, and thanks to the `gganimate` package, making animated plots is super easy
...
## animated plots
- `gganimate` works by having `transition_...` functions that can change the color or positions of geoms based on a time or another continuous variable
