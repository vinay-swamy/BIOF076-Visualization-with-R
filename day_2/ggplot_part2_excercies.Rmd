...
- some hints: the following geoms are required: `geom_line`, `geom_label`, `geom_label_repel`, `geom_vline` and `geom_errorbar`. You will have to change several theme settings, and scale at least one aesthtic for one of the geoms
