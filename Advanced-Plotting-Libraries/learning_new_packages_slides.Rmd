...
- This is an *very* useful skill, as there are always new visualizations packages coming out.
...
- if you are looking for a package to do something, try googling <thing> R package, ie forest plot R package 
...
- most packages will have some sort of web-based documentation. At the very least, all packages will have documentation within R itself that you can view with the `?` command
