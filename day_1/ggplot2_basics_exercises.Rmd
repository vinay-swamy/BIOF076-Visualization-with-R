...
```{r}
ggplot(ToothGrowth) + 
      geom_boxplot(mapping = aes(x=supp, 
                                y= len, 
                                fill = supp)
               )
...
ggplot(hospital_data) + 
  geom_boxplot(aes(x=Hospital_location, 
                   y= age,fill = Hospital_location))
```
...
```{r}
ggplot(hospital_data) + 
  geom_violin(aes(x=Hospital_location, 
                   y= age,fill = Hospital_location))
```
...
ggplot(hospital_data) + 
    geom_histogram( aes(x=age, fill=Hospital_location))
