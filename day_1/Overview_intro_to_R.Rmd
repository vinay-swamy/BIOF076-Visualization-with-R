...
- Researchers who needed to use statistics used R because it is free and open source.
...
2. Converting raw data into the format suitable for plotting.
...
- Memory: (also known as RAM) Basically the exact opposite of disk - *cannot* store a lot of, but what is stored can be accessed quickly.
...
- Vectors can be joined, or concatenated similar to how they created
