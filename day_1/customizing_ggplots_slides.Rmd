...
- we can se in the `theme` function there are multiple inputs for textual parts of the text like `plot.title`, or `axis.text.x`
...
## colors in R
- color palettes refer the st of colors you use within your plot.
...
- This can be especially difficult when choosing a continuous fill, because certain colors dont work well as a gradient
...
## useful pacakges to generate color palettes
...
## quick note about using discete scales from the `pals` pacakge
...
## other aesthetics 
- there are a couple other aesthetics we havent covered; some are specific to different plots 
...
## width
- alway a good idea to spend some time looking through the documentation about what aethetics work for what geoms 
