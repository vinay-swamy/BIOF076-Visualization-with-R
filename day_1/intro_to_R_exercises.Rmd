...
change the last value in wild_type from 0 to -1 (hint: you will need to first access wild_type within the list, and then acces the first element within wild_type)
...
- this is a small data frame we'll be working with. The numbers are all made up
