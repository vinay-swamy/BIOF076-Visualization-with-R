...
- Researchers who need to use statisticsused R because it is free and open source unlike Stata or SPSS
...
## getting course materials for the course
1. Open Rstudio 
2. Go to the terminal in the bottom left panel 
3. type in this command git clone https://github.com/vinay-swamy/BIOF076-Visualization-with-R.git
