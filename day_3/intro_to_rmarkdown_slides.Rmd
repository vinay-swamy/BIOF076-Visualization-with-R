...
- the same document can be converted to multiple out put formats, which are set in the yaml header of the document
```
---
title: "Intro to RMarkdown"
author: "Vinay Swamy"
...
## why should you make a scietific poster in R
